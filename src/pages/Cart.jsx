...
const KEY = "pk_test_51MLxEcBfznap3Ncigw31qZxhXLKqZhnAIFTdlESqTedpJnzD05enhv6olXql7UsT7B7NNKo6njL3rshrWdKbBcLK00Dh4Qhvkn";
...
const Cart = () => {
  ...
  const [stripeToken, setStripeStoken] = useState(null)
  const navigate = useNavigate()

  const onToken = (token) =>{
    setStripeStoken(token)
  }
